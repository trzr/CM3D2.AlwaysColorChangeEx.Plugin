...
//        public static readonly Dictionary<int, SlotInfo> MaskSlots = new Dictionary<int, SlotInfo>(Enum.GetNames(typeof(TBody.SlotID)).Length);
        ...
        public static readonly Dictionary<string, NodeItem> NodeNames = new Dictionary<string, NodeItem>() {
            {"Bip01 Head",         new NodeItem("頭", 0) },
            {"Bip01 Neck_SCL_",    new NodeItem("首", 0) },
            {"Mune_L_sub",         new NodeItem("左胸上", 1)},
            {"Mune_L",             new NodeItem("左胸下", 2) },
            {"Mune_R_sub",         new NodeItem("右胸上", 1) },
            ...
            {"Hip_R",              new NodeItem("右尻", 1) },
            {"momotwist_L",        new NodeItem("左前腿", 2) },
            {"momoniku_L",         new NodeItem("左後腿", 2) },
            {"momotwist2_L",       new NodeItem("左前腿下部", 2) },
            {"Bip01 L Thigh_SCL_", new NodeItem("左ふくらはぎ", 2) },
            {"Bip01 L Calf_SCL_",  new NodeItem("左足下腿", 2) },
            {"Bip01 L Foot",       new NodeItem("左足首", 3) },
            {"Bip01 L Toe0",       new NodeItem("左足小指付け根", 4) },
            {"Bip01 L Toe01",      new NodeItem("左足小指先", 5) },
            {"Bip01 L Toe1",       new NodeItem("左足中指付け根", 4) },
            {"Bip01 L Toe11",      new NodeItem("左足中指先", 5) },
            {"Bip01 L Toe2",       new NodeItem("左足親指付け根", 4) },
            {"Bip01 L Toe21",      new NodeItem("左足親指先", 5) },
            {"momotwist_R",        new NodeItem("右前腿", 2) },
            {"momoniku_R",         new NodeItem("右後腿", 2) },
            {"momotwist2_R",       new NodeItem("右前腿下部", 2) },
            {"Bip01 R Thigh_SCL_", new NodeItem("右ふくらはぎ", 2) },
            {"Bip01 R Calf_SCL_",  new NodeItem("右足下腿", 2) },
            {"Bip01 R Foot",       new NodeItem("右足首", 3) },
            {"Bip01 R Toe0",       new NodeItem("右足小指付け根", 4) },
            {"Bip01 R Toe01",      new NodeItem("右足小指先", 5) },
            {"Bip01 R Toe1",       new NodeItem("右足中指付け根", 4) },
            {"Bip01 R Toe11",      new NodeItem("右足中指先", 5) },
            {"Bip01 R Toe2",       new NodeItem("右足親指付け根", 4) },
            {"Bip01 R Toe21",      new NodeItem("右足親指先", 5) },
            {"Bip01 L Clavicle_SCL_", new NodeItem("左鎖骨", 0) },
            {"Kata_L",             new NodeItem("左肩", 0) },
            {"Kata_L_nub",         new NodeItem("左肩上腕", 1) },
            {"Uppertwist_L",       new NodeItem("左上腕A", 2) },
            {"Uppertwist1_L",      new NodeItem("左上腕B", 2) },
            {"Bip01 L UpperArm",   new NodeItem("左上腕", 2) },
            {"Bip01 L Forearm",    new NodeItem("左肘", 2) },
            {"Foretwist1_L",       new NodeItem("左前腕", 2) },
            {"Foretwist_L",        new NodeItem("左手首", 2) },
            {"Bip01 L Hand",       new NodeItem("左手", 3) },
            {"Bip01 L Finger0",    new NodeItem("左親指付け根", 4) },
            {"Bip01 L Finger01",   new NodeItem("左親指関節", 5) },
            {"Bip01 L Finger02",   new NodeItem("左親指先", 6) },
            {"Bip01 L Finger1",    new NodeItem("左人指し指付け根", 4) },
            {"Bip01 L Finger11",   new NodeItem("左人指し指関節", 5) },
            {"Bip01 L Finger12",   new NodeItem("左人指し指先", 6) },
            {"Bip01 L Finger2",    new NodeItem("左中指付け根", 4) },
            {"Bip01 L Finger21",   new NodeItem("左中指関節", 5) },
            {"Bip01 L Finger22",   new NodeItem("左中指先", 6) },
            {"Bip01 L Finger3",    new NodeItem("左薬指付け根", 4) },
            {"Bip01 L Finger31",   new NodeItem("左薬指関節", 5) },
            {"Bip01 L Finger32",   new NodeItem("左薬指先", 6) },
            {"Bip01 L Finger4",    new NodeItem("左小指付け根", 4) },
            {"Bip01 L Finger41",   new NodeItem("左小指関節", 5) },
            {"Bip01 L Finger42",   new NodeItem("左小指先", 6) },
            {"Bip01 R Clavicle_SCL_", new NodeItem("右鎖骨", 0) },
            {"Kata_R",             new NodeItem("右肩", 1) },
            {"Kata_R_nub",         new NodeItem("右肩上腕", 1) },
            {"Uppertwist_R",       new NodeItem("右上腕A", 2) },
            {"Uppertwist1_R",      new NodeItem("右上腕B", 2) },
            {"Bip01 R UpperArm",   new NodeItem("右上腕", 2) },
            {"Bip01 R Forearm",    new NodeItem("右肘", 2) },
            {"Foretwist1_R",       new NodeItem("右前腕", 2) },
            {"Foretwist_R",        new NodeItem("右手首", 2) },
            {"Bip01 R Hand",       new NodeItem("右手", 3) },
            {"Bip01 R Finger0",    new NodeItem("右親指付け根", 4) },
            {"Bip01 R Finger01",   new NodeItem("右親指関節", 5) },
            {"Bip01 R Finger02",   new NodeItem("右親指先", 6) },
            {"Bip01 R Finger1",    new NodeItem("右人指し指付け根", 4) },
            {"Bip01 R Finger11",   new NodeItem("右人指し指関節", 5) },
            {"Bip01 R Finger12",   new NodeItem("右人指し指先", 6) },
            {"Bip01 R Finger2",    new NodeItem("右中指付け根", 4) },
            {"Bip01 R Finger21",   new NodeItem("右中指関節", 5) },
            {"Bip01 R Finger22",   new NodeItem("右中指先", 6) },
            {"Bip01 R Finger3",    new NodeItem("右薬指付け根", 4) },
            {"Bip01 R Finger31",   new NodeItem("右薬指関節", 5) },
            {"Bip01 R Finger32",   new NodeItem("右薬指先", 6) },
            {"Bip01 R Finger4",    new NodeItem("右小指付け根", 4) },
            {"Bip01 R Finger41",   new NodeItem("右小指関節", 5) },
            {"Bip01 R Finger42",   new NodeItem("右小指先", 6) },
        };
    }
    ...
    public class NodeItem {
        ...
        public NodeItem(string dispName, int depth) {
            this.DisplayName = dispName;
            this.depth = depth;
        }
        public NodeItem(string name, string dispName, int depth) {
            this.Name = name;
            this.DisplayName = dispName;
            this.depth = depth;
        }
