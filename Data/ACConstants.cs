...
//        public static readonly Dictionary<int, SlotInfo> MaskSlots = new Dictionary<int, SlotInfo>(Enum.GetNames(typeof(TBody.SlotID)).Length);
        ...
        public static readonly Dictionary<string, NodeItem> NodeNames = new Dictionary<string, NodeItem>() {
            ...
            {"Mune_R_sub",         new NodeItem("右胸上", 1, TBody.SlotID.bra, TBody.SlotID.mizugi, TBody.SlotID.wear, TBody.SlotID.onepiece) },
            {"Mune_R",             new NodeItem("右胸下", 2, TBody.SlotID.bra, TBody.SlotID.mizugi, TBody.SlotID.wear, TBody.SlotID.onepiece) },
            ...
            {"Bip01 Spine0a_SCL_", new NodeItem("腹部", 0, TBody.SlotID.mizugi, TBody.SlotID.wear, TBody.SlotID.onepiece, TBody.SlotID.skirt, TBody.SlotID.stkg) },
            {"Bip01 Spine1_SCL_",  new NodeItem("腰中", 0, TBody.SlotID.mizugi, TBody.SlotID.wear, TBody.SlotID.onepiece, TBody.SlotID.skirt, TBody.SlotID.stkg) },
            {"Bip01 Spine1a_SCL_", new NodeItem("胸部", 0, TBody.SlotID.mizugi, TBody.SlotID.wear, TBody.SlotID.onepiece) },
            ...
            {"momoniku_L",         new NodeItem("左後腿", 2, TBody.SlotID.stkg, TBody.SlotID.shoes) },
            {"momotwist2_L",       new NodeItem("左前腿下部", 2, TBody.SlotID.stkg, TBody.SlotID.shoes) },
            {"Bip01 L Thigh_SCL_", new NodeItem("左ふくらはぎ", 2, TBody.SlotID.stkg, TBody.SlotID.shoes) },
            ...
            {"momoniku_R",         new NodeItem("右後腿", 2, TBody.SlotID.stkg, TBody.SlotID.shoes) },
            {"momotwist2_R",       new NodeItem("右前腿下部", 2, TBody.SlotID.stkg, TBody.SlotID.shoes) },
            {"Bip01 R Thigh_SCL_", new NodeItem("右ふくらはぎ", 2, TBody.SlotID.stkg, TBody.SlotID.shoes) },
            ...
            {"Bip01 L Clavicle_SCL_", new NodeItem("左鎖骨", 0, TBody.SlotID.wear, TBody.SlotID.onepiece, TBody.SlotID.mizugi) },
            {"Kata_L",             new NodeItem("左肩", 0, TBody.SlotID.wear, TBody.SlotID.onepiece, TBody.SlotID.mizugi) },
            {"Kata_L_nub",         new NodeItem("左肩上腕", 1, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Uppertwist_L",       new NodeItem("左上腕A", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Uppertwist1_L",      new NodeItem("左上腕B", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Bip01 L UpperArm",   new NodeItem("左上腕", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Bip01 L Forearm",    new NodeItem("左肘", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Foretwist1_L",       new NodeItem("左前腕", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Foretwist_L",        new NodeItem("左手首", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Bip01 L Hand",       new NodeItem("左手", 3, TBody.SlotID.glove) },
            {"Bip01 L Finger0",    new NodeItem("左親指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 L Finger01",   new NodeItem("左親指関節", 5, TBody.SlotID.glove) },
            {"Bip01 L Finger02",   new NodeItem("左親指先", 6, TBody.SlotID.glove) },
            {"Bip01 L Finger1",    new NodeItem("左人指し指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 L Finger11",   new NodeItem("左人指し指関節", 5, TBody.SlotID.glove) },
            {"Bip01 L Finger12",   new NodeItem("左人指し指先", 6, TBody.SlotID.glove) },
            {"Bip01 L Finger2",    new NodeItem("左中指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 L Finger21",   new NodeItem("左中指関節", 5, TBody.SlotID.glove) },
            {"Bip01 L Finger22",   new NodeItem("左中指先", 6, TBody.SlotID.glove) },
            {"Bip01 L Finger3",    new NodeItem("左薬指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 L Finger31",   new NodeItem("左薬指関節", 5, TBody.SlotID.glove) },
            {"Bip01 L Finger32",   new NodeItem("左薬指先", 6, TBody.SlotID.glove) },
            {"Bip01 L Finger4",    new NodeItem("左小指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 L Finger41",   new NodeItem("左小指関節", 5, TBody.SlotID.glove) },
            {"Bip01 L Finger42",   new NodeItem("左小指先", 6, TBody.SlotID.glove) },
            {"Bip01 R Clavicle_SCL_", new NodeItem("右鎖骨", 0, TBody.SlotID.wear, TBody.SlotID.onepiece, TBody.SlotID.mizugi) },
            {"Kata_R",             new NodeItem("右肩", 1, TBody.SlotID.wear, TBody.SlotID.onepiece, TBody.SlotID.mizugi) },
            {"Kata_R_nub",         new NodeItem("右肩上腕", 1, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Uppertwist_R",       new NodeItem("右上腕A", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Uppertwist1_R",      new NodeItem("右上腕B", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Bip01 R UpperArm",   new NodeItem("右上腕", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Bip01 R Forearm",    new NodeItem("右肘", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Foretwist1_R",       new NodeItem("右前腕", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Foretwist_R",        new NodeItem("右手首", 2, TBody.SlotID.glove, TBody.SlotID.accUde, TBody.SlotID.wear) },
            {"Bip01 R Hand",       new NodeItem("右手", 3, TBody.SlotID.glove) },
            {"Bip01 R Finger0",    new NodeItem("右親指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 R Finger01",   new NodeItem("右親指関節", 5, TBody.SlotID.glove) },
            {"Bip01 R Finger02",   new NodeItem("右親指先", 6, TBody.SlotID.glove) },
            {"Bip01 R Finger1",    new NodeItem("右人指し指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 R Finger11",   new NodeItem("右人指し指関節", 5, TBody.SlotID.glove) },
            {"Bip01 R Finger12",   new NodeItem("右人指し指先", 6, TBody.SlotID.glove) },
            {"Bip01 R Finger2",    new NodeItem("右中指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 R Finger21",   new NodeItem("右中指関節", 5, TBody.SlotID.glove) },
            {"Bip01 R Finger22",   new NodeItem("右中指先", 6, TBody.SlotID.glove) },
            {"Bip01 R Finger3",    new NodeItem("右薬指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 R Finger31",   new NodeItem("右薬指関節", 5, TBody.SlotID.glove) },
            {"Bip01 R Finger32",   new NodeItem("右薬指先", 6, TBody.SlotID.glove) },
            {"Bip01 R Finger4",    new NodeItem("右小指付け根", 4, TBody.SlotID.glove) },
            {"Bip01 R Finger41",   new NodeItem("右小指関節", 5, TBody.SlotID.glove) },
            {"Bip01 R Finger42",   new NodeItem("右小指先", 6, TBody.SlotID.glove) },
        };
    }
