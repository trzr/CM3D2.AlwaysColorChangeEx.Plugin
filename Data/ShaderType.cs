    ...
    public class ShaderType
    {
        ...
        static void Init() {
            ...
            shaders = new ShaderType[] {
                ...
                new ShaderType("CM3D2/Toony_Lighted_Trans",　"トゥーン 透過",              texType1a, colTL,  propTL, true ),
                new ShaderType("CM3D2/Toony_Lighted_Trans_NoZ",　"トゥーン 透過 NoZ",      texType1a, colTL,  propTL, true ),
                new ShaderType("CM3D2/Toony_Lighted_Outline","トゥーン 輪郭線",            texType1, colTLO, propTLO ),
                new ShaderType("CM3D2/Toony_Lighted_Outline_Trans","トゥーン 輪郭線 透過", texType1a, colTLO, propTLO, true ),
                ...
                new ShaderType("CM3D2/Lighted_Trans","透過",            texType0a, colL,     propL, true ),
                ...
                new ShaderType("Transparent/Diffuse","リアル 透過",     texType0a, colC,     propEmpty, true ),
...
//        public ShaderPropTex GetTexProp(string propName) {
//            try {
//                var propKey = (PropKey)Enum.Parse(typeof(PropKey), propName);
//                switch (propKey) {
//                    case PropKey._MainTex:
...
//            return null;
//        }
//        public PropKey GetIncludeProp(string propName) {
//            try {
//                var propKey = (PropKey)Enum.Parse(typeof(PropKey), propName);
//                switch (propKey) {
//                    case PropKey._MainTex:
